        ...
        <>
            <div>
                <ul className='flex flex-col gap-y-10  '>
                    <div className='flex sm:gap-x-2 md:gap-x-4 cursor-pointer' onClick={()=>nav('/home')}>
                    ...
                    <div className='flex sm:gap-x-2 md:gap-x-4 cursor-pointer ' onClick={()=>nav('/patientform')}>
