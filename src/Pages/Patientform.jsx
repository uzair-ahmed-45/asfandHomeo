...
export default function Patientform() {
    return (
        <>
            <Navbar />
            <div className='h-[150vh] bg-gray-200 ms-0 sm:h-screen sm:ms-44 md:ms-48 lg:ms-80 w-[70vw] m-auto flex justify-between sm:justify-center flex-col sm:flex-row '>
                <form action="" className='px-5 py-5 mt-0 sm:mt-20 bg-white rounded-xl shadow-xl flex flex-col justify-between gap-y-4 w-[90vw] sm:w-[55vw] '>
                    ...
                    <div className='flex justify-between items-center gap-x-2 sm:gap-x-5'>
                        <label htmlFor="" className='sm:text-lg text-xs'>Occupation</label>
