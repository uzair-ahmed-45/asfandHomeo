...
export default function Patientform() {
    return (
        <>
            <Navbar />
            <div className='h-[150vh] ms-0 sm:h-screen sm:ms-44 md:ms-48 lg:ms-80 w-[70vw] m-auto flex justify-center flex-col sm:flex-row '>
                <form action="" className='px-5 py-5 mt-5 sm:mt-20 bg-white rounded-xl shadow-xl flex flex-col justify-between gap-y-4 w-[80vw] sm:w-[55vw] '>
