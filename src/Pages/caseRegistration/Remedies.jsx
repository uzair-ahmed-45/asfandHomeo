...
export default function Remedies() {
    ...
    const submit = async () => {
        const remediesObj = {
            complainId,
            remedies: remediesData.remedies.join(', ')
        };
        try {
                    ...
                    <div className='sm:flex h-auto py-20 sm:py-10 bg-gray-200'>
                        ...
                        <div className='flex flex-col gap-y-5 justify-center sm:justify-between items-center w-[90vw] sm:w-[70vw] md:w-[70vw] lg:w-[60vw] md:ms-64 sm:ms-48 lg:ms-80 ms-5 xl:ms-[450px] bg-white mt-10 sm:mt-10 py-5 rounded-xl shadow-xl px-5'>
                            ...
                            <div className='flex flex-col justify-between gap-y-5 w-[70vw] sm:w-full '>
                                ...
                                {complain?.complain?.childhoodHistory ? <> q
                                ...
                                <div className='flex justify-center gap-x-5 mt-5'>
                                    ...
                                    <Button name="Generate Report" class="sm:px-10 px-6 hover:transform-none sm:text-base text-xs" />
                                </div>
                                {
                                    remediesModal &&
                                    <>
                                        ...
                                        <div className="flex flex-col justify-center items-center sm:gap-y-5 fixed left-[50%] top-[50%] w-[90vw] sm:w-[60vw] sm:h-auto h-[70vh]  bg-[white] rounded-lg shadow-lg sm:py-4 px-4" style={{ transform: "translate(-50% , -50%)" }}>
