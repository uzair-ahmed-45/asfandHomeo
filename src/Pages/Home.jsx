    ...
    <>
      {loader ? <Spinner /> :
        <>
          <Navbar />
          <div className=''>
            <div className='flex md:flex-row flex-col justify-evenly gap-y-5 md:justify-between sm:w-[75vw] m-auto sm:px-40 md:px-20 gap-x-4 lg:px-32 px-16 sm:py-40 py-24 bg-gray-200  h-screen items-center sm:ms-40  lg:ms-60 xl:ms-80 text-center z-0'>
